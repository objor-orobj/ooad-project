...
class GoodsControllerTest {
    ...
    void addSpuToBrand1() throws Exception{
        String responseString = this.mvc.perform(post("/shops/1/spus/680/brands/102"))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectedResponse="{\n" +
    ...
    void removeSpuFromBrand1() throws Exception{
        String responseString = this.mvc.perform(
                delete("/shops/1/spus/680/brands/102"))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectedResponse="{\n" +
    ...
    void removeSpuFromBrand2() throws Exception{
        String responseString = this.mvc.perform(
                delete("/shops/1/spus/680/brands/1"))
                .andExpect(status().isNotFound())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectedResponse="{\n" +
    ...
    void removeSpuFromBrand3() throws Exception{
        String responseString = this.mvc.perform(
                delete("/shops/1/spus/680/brands/103"))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectedResponse="{\n" +
    ...
    void removeSpuFromCategory1() throws Exception{
        String responseString = this.mvc.perform(
                delete("/shops/1/spus/680/categories/122"))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectedResponse="{\n" +
    ...
    void removeSpuFromCategory2() throws Exception{
        String responseString = this.mvc.perform(
                delete("/shops/1/spus/680/categories/1"))
                .andExpect(status().isNotFound())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectedResponse="{\n" +
    ...
    void removeSpuFromCategory3() throws Exception{
        String responseString = this.mvc.perform(
                delete("/shops/1/spus/680/categories/123"))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"))
                .andReturn().getResponse().getContentAsString();
        String expectedResponse="{\n" +
